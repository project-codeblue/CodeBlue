  ...
  async getNearbyHospitals(emogList: string[]) {
    ...
    await axios({
      ...
      $('#area_dashboards').each((idx, element) => {
        ...
        results.push(`${emogList} / ${name} 응급실: ${ungeup}, 수술실: ${susul}, 신경중환자실: ${singyeong}, 신생아중환자실: ${sinseng}, 흉부중환자실: ${hyungbu}, 일반중환자실: ${ilban}, 입원실: ${ibwon}, 내과중환자실: ${naeggwa}, 외과중환자실: ${weggwa}, 신경외과중환자실: ${singyeongwe}`);
      });
    });
